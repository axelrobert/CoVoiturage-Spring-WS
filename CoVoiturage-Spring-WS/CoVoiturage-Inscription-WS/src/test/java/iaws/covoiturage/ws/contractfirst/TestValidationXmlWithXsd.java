...
public class TestValidationXmlWithXsd {
	...
	public void testValidate() throws SAXException, IOException {
		...
		InputSource sourceentree = new InputSource(new FileInputStream(new File("src/main/resources/CoVoiturageIns.xsd")));
		SAXSource sourceXSD = new SAXSource(sourceentree);
		Schema schema = factory.newSchema(sourceXSD);
		Validator validator = schema.newValidator() ;
		validator.validate(new StreamSource(new File("src/main/resources/CoVoiturageIns.xml"))) ;
	}
